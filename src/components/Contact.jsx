              ...
              <div className="card p-8">
                ...
                <div className="space-y-6">
                  <div className="flex items-start">
                    ...
                    <div className="ml-4">
                      ...
                      <a href="mailto:raj113192007@gmail.com" className="text-primary-600 dark:text-primary-400 hover:underline">
                  ...
                  <div className="flex items-start">
                    <div className="flex-shrink-0 bg-secondary-100 dark:bg-secondary-900/30 p-3 rounded-full">
                      <HiPhone className="w-6 h-6 text-secondary-600 dark:text-secondary-400" />
                    </div>
                    <div className="ml-4">
                      <h4 className="text-lg font-medium text-gray-700 dark:text-gray-300">Phone</h4>
                      <a href="tel:+917061121632" className="text-secondary-600 dark:text-secondary-400 hover:underline">
                        +91 7061121632
                      </a>
                    </div>
                  </div>
                ...
                <div className="mt-10">
                  ...
                  <div className="flex space-x-4">
                    ...
                    <motion.a 
                      href="#" 
                      className="p-3 bg-gray-100 dark:bg-gray-800 rounded-full hover:bg-blue-100 dark:hover:bg-blue-900/30 transition-all duration-300 group"
                      whileHover={{ scale: 1.1, y: -2 }}
                      whileTap={{ scale: 0.95 }}
                    >
                      <svg className="w-5 h-5 text-gray-700 dark:text-gray-300 group-hover:text-blue-500" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                    ...
                    <motion.a 
                      href="#" 
                      className="p-3 bg-gray-100 dark:bg-gray-800 rounded-full hover:bg-gray-200 dark:hover:bg-gray-700 transition-all duration-300 group"
                      whileHover={{ scale: 1.1, y: -2 }}
                      whileTap={{ scale: 0.95 }}
                    >
                      <svg className="w-5 h-5 text-gray-700 dark:text-gray-300 group-hover:text-gray-900 dark:group-hover:text-white" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                    ...
                    <motion.a 
                      ...
                      whileTap={{ scale: 0.95 }}
                    >
                      <svg className="w-5 h-5 text-gray-700 dark:text-gray-300 group-hover:text-blue-600" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
